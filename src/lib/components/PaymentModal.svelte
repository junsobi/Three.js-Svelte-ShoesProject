...
<div
	class="fixed left-0 top-0 flex h-full w-full items-center justify-center bg-black bg-opacity-50 py-3"
>
	<div class="max-h-full w-full max-w-xl overflow-y-auto sm:rounded-2xl bg-white">
		<div class="w-full">
			<div class="m-8 my-10 max-w-[400px] mx-auto">
							...
							<tr class="text-center text-gray-500">
								...
								<td>
									<div class="center-content">
										{#if texture}
											<img class="w-10 h-10 rounded-full" src={getImageUrl(texture)} {alt} />
										{:else}
				...
				<div class="space-y-4">
					<button class="p-3 bg-white border rounded-full w-full font-semibold" on:click={close}
						>조금 더 고르기</button
					>
